...
def call_llama_combine(caption):
    response = llm.invoke(f"""
        Caption 1: {caption[0]},
        Caption 2: {caption[1]},
        Caption 3: {caption[2]},
        ...
        Your job is to generate the most coherent caption describing the full image with the help of the captions given above of the image divided into
        equal parts. 
        Your response should not contain any other information aside from the caption
        Only include the caption in your response and nothing else
        Do not include any unwanted intro and any unwanted information in the response aside from the caption
